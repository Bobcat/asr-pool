...
from pool_config import get_str, get_int, get_float, get_bool
...
class AsrPoolService:
    def __init__(self) -> None:
        ...
        self._watchdog_recover_timeout_s = get_int(
            "lifecycle.watchdog.recover_timeout_s",
            30,
            min_value=1,
        )
        self._records_max = get_int("records.max", 10000, min_value=100)
        self._records_ttl_s = {
        ...
        self._records_prune_interval_s = get_int("records.prune_interval_s", 30, min_value=1)
